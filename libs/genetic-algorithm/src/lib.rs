...
impl SelectionMethod for RouletteWheelSelection {
        ...
        I: Individual,
    {
        population
            ...
            .expect("Recieved empty population")
    }
}
...
impl Index<usize> for Chromosome { // Allows for basic indexing.
    type Output = f32;
    fn index(&self, index:usize) -> &Self::Output {
        &self.genes[index]
    }
}
impl FromIterator<f32> for Chromosome { // Allows to collect into my type.
...
impl IntoIterator for Chromosome { // Converts type into iterator.
    type Item = f32;
